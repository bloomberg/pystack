...
class CoreFileAnalyzer:
    def __init__(
        ...
        lib_search_path: Optional[Union[str, pathlib.Path]] = None,
    ) -> None: ...
    ...
    def extract_maps(self) -> List[VirtualMap]: ...
    def extract_pid(self) -> int: ...
    def extract_ps_info(self) -> Dict[str, Any]: ...
    def missing_modules(self) -> Set[pathlib.Path]: ...
...
def get_process_threads_for_core(
    core_file: Union[str, pathlib.Path],
    executable: Union[str, pathlib.Path],
    library_search_path: Optional[Union[str, pathlib.Path]] = None,
